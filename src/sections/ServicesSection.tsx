      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="border-t border-[#0C0C0C]/15 w-full">
          {SERVICES.map((service, index) => (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center py-8 sm:py-10 md:py-12 gap-4 sm:gap-8 md:gap-12">
                {/* Number */}
                <div
                  className="font-black leading-none text-[#0C0C0C] shrink-0 select-none"
